...
void AC7PCGMergeActor::CopyComponentProperty(class UActorComponent* SourceComponent, class UActorComponent* TargetComponent, class AActor* SourceActor)
{
#if WITH_EDITOR
