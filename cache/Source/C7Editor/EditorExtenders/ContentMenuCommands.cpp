...
//////////////////////////////////////////////////////////////////////////
// FContentMenuCommands

#define LOCTEXT_NAMESPACE "FContentMenuCommands"


void FContentMenuCommands::RegisterCommands()
{
	UI_COMMAND(FixArtTestAssetsReference, "FixArtTestAssetsReference", "FixArtTestAssetsReference", EUserInterfaceActionType::Button, FInputChord());

	UI_COMMAND(CleanCustomizePkgHead, "CleanCustomizePkgHead", "CleanCustomizePkgHead", EUserInterfaceActionType::Button, FInputChord());
	
	UI_COMMAND(GameLoopCommands, "GameLoop", "GameLoop", EUserInterfaceActionType::Button, FInputChord(EModifierKey::Shift | EModifierKey::Alt,EKeys::G)); 
