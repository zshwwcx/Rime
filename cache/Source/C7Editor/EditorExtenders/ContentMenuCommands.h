...
class FContentMenuCommands : public TCommands<FContentMenuCommands>
{
public:
	FContentMenuCommands()
		: TCommands<FContentMenuCommands>(TEXT("C7Editor"), NSLOCTEXT("Contexts", "C7Editor", "C7 Editor"), NAME_None, "C7EditorStyle")
	{
	}
	...
	TSharedPtr<FUICommandInfo> FixArtTestAssetsReference;

	TSharedPtr<FUICommandInfo> CleanCustomizePkgHead;
	...
	///** Game Loop */
	TSharedPtr<FUICommandInfo> GameLoopCommands;
};
